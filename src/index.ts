        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              sales_tax_rate: { type: 'string', description: 'VAT rate as a percentage, e.g. "20.0". For a fixed VAT amount that is not a clean percentage of gross, use manual_sales_tax_amount instead.' },
              ...
              manual_sales_tax_amount: { type: 'string', description: 'Exact VAT amount in native currency — use when VAT is not a simple percentage of gross (e.g. only part of the cost is VATable, as on marketplace/eBay invoices). Works on any expense, domestic included. Overrides sales_tax_rate; must not exceed the gross value.' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              sales_tax_rate: { type: 'string', description: 'New VAT rate, e.g. "20.0". For a fixed VAT amount, use manual_sales_tax_amount instead.' },
              ...
              manual_sales_tax_amount: { type: 'string', description: 'Exact VAT amount in native currency — use when VAT is not a simple percentage of gross. Overrides sales_tax_rate; must not exceed the gross value.' },
